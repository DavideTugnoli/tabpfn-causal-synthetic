...
def generate_branch_csv(
    *,
    ...
    file_path = base_dir / f"custom_{dataset_kind}_intervention_x3_eq_{x3_value:g}.csv"
...
def main() -> None:
    ...
    generate_branch_csv(samples=args.samples_per_branch, x3_value=0.0, seed=seed0, mode=args.mode, overwrite=args.overwrite)
    generate_branch_csv(samples=args.samples_per_branch, x3_value=1.0, seed=seed1, mode=args.mode, overwrite=args.overwrite)
