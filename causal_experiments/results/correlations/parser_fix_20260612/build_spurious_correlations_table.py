#!/usr/bin/env python3
"""Rebuild the Custom SCM spurious-correlation table from a canonical NPZ archive."""
...
def main() -> None:
    ...
    cleaned_path = archive_root / "cleaned_csv/result_custom_scm_comparison_experiment_cleaned_reps_100.csv"
    dataset_root = archive_root / "datasets/custom_scm"
